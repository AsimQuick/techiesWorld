...
business, government agencies, and individuals with tech needs.</p>
                    ...
                    <h3 className="mb-4 md:text-2xl text-xl font-medium text-white text-center pt-4 font-lexend">Our Partners</h3>
                            ...
                            <image src="/images/logos/safaricom-logo2.png" className="rounded-md shadow-lg" alt="" width={0} height={0} sizes='65px' style={{width:"70%", height:"auto"}} />
                            <image src="/images/logos/rwandastandardsboard-logo2.png" className="rounded-md shadow-lg" alt="" width={0} height={0} sizes='65px' style={{width:"65%", height:"auto"}} />
                            <image src="/images/logos/oracle-logo2.png" className="rounded-md shadow-lg" alt="" width={0} height={0} sizes='65px' style={{width:"70%", height:"auto"}} />
                            <image src="/images/logos/mtn-logo3.png" className="rounded-md shadow-lg" alt="" width={0} height={0} sizes='65px' style={{width:"70%", height:"auto"}} />
                            <image src="/images/logos/microsoft-logo2.png" className="rounded-md shadow-lg" alt="" width={0} height={0} sizes='65px' style={{width:"70%", height:"auto"}} />
                            <image src="/images/logos/etisalat-logo5.png" className="rounded-md shadow-lg" alt="" width={0} height={0} sizes='65px' style={{width:"70%", height:"auto"}} />
                                </div>
                </div>
                </section>
