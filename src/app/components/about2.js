                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 md:grid-cols-2 gap-10 items-center">
                        ...
                        <div className="lg:col-span-7">
                            <div className="lg:ms-7">
                                ...
                                Our services are tailored to meet the specific needs of our clients and include everything from Information Technology to quality management and assurance. We have a team of experienced professionals who ensure that our clients receive the highest quality service and the best value for money.</p>
