                ...
                <div className="container flex flex-wrap items-center justify-end">
                    <a className="navbar-brand md:me-8" href="/">
                        <span className="inline-block dark:hidden">
                            <Image src="/images/techies-world-logo.png" className="l-dark" alt="" width={113} height={28}/>
                            <Image src="/images/techies-world-logo-white.png" className="l-light" alt="" width={113} height={28}/>
                        </span>
                        <Image src="/images/techies-world-logo.png" className="hidden dark:inline-block" alt="" width={113} height={28}/>
                    </a>
                    ...
                    <div className={`${isOpen === true ? 'navigation lg_992:order-1 lg_992:flex hidden ms-auto' : 'navigation lg_992:order-1 lg_992:flex block ms-auto'}`} id="menu-collapse">
                        <ul className="navbar-nav nav-light" id="navbar-navlist">
                            ...
                            <li className={`nav-item`}>
                                <Link1 to="services" activeClass="active" spy={true} smooth={true} duration={700} className="nav-link">Services</Link1>
                            </li>
